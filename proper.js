...
class SnapLensProper {
  ...
  async openGalleryPreview(id) {
    ...
    // IMPORTANT: toggle 'show' (CSS controls display with this)
    this.galleryPreview.classList.add('show');
  }
  ...
  wireGalleryPreview() {
    ...
    this.closeGalleryBtn?.addEventListener('click', () => {
      // Remove 'show' so CSS hides it
      this.galleryPreview.classList.remove('show');
